...
#         style the progressbar'style : can be either Green'n'Pink ou Turbo, Green'n'Pink by default'''
...
#         self._style_to_func = {"Turbo":self._print_progress_turbo}
#         self._print_progress_bar = self._style_to_func.get(style, self._print_progress_greenPink) #green pink by default
...
#         """
#         # Points de contrôle (fraction, (R,G,B))
#         stops = [
#             (0.0, (0, 0, 255)),     # bleu
#             (0.25, (0, 255, 0)),    # vert
#             (0.5, (255, 255, 0)),   # jaune
...
#                 return rgb(r,g,b)
#         return rgb(255,0,0)  # fallback rouge

#     def _print_progress_turbo(self, percentage: float):
#         """
#         Barre turbo: [====>----] avec dégradé de couleur sur les '=', du bleu au rouge en passant par le vert puis jaune puis orange
#         """
#         filled = int((percentage/100) * self._width)
#         empty = self._width - filled
...
#         if filled > 0:
#             bar = bar[:-1] + self._color_gradient(frac) + ">"  # remplacer le dernier '=' par la tête
#         bar += RESET
#         bar += "-" * empty
#         bar += "]"
